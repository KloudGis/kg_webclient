...
Signup.LocationView = Signup.InputView.extend({
	
	layerId: 'locationViewId',
	
	//trace: YES,
	init: function(){
		sc_super();
		this.get('textfield').bind('value',  SC.Binding.from('Signup.signupController.location'));
	},
    ...
    startState: SC.State.design({
        ...
        enterState: function() {
            ...
            view.labelView.set('value', 'Ville:'),
			view.helpView.labelHelp.set('value', "La ville où vous vous trouvez.");
    ...
    focusIn: SC.State.design({
        ...
        focusMissingState: SC.State.design({
            ...
            enterState: function() {
                var view = this.get('statechart');
                view.helpView.labelHelp.set('value', "Votre ville est requise.");
                view.displayDidChange();
            },
        ...
        focusOkState: SC.State.design({
            ...
            enterState: function() {
                var view = this.get('statechart');
                view.helpView.labelHelp.set('value', "Votre ville est valide.");
                view.displayDidChange();
            },
    ...
    transientFocusTestValid: SC.State.design({
        ...
        enterState: function() {
            Signup.testLocation(this.get('statechart'));
        },
