...
module("Ember.NestedStore#readEditableDataHash", {
  setup: function() {
...
test("data state=INHERITED, parent editable = NO", function() {
  ...
  // test preconditions
  equals(parent.storeKeyEditState(storeKey), Ember.Store.LOCKED, 'precond - parent edit state should be LOCKED');
...
test("data state=INHERITED, parent editable = YES", function() {
  ...
  equals(parent.storeKeyEditState(storeKey), Ember.Store.EDITABLE, 'precond - parent edit state should be EDITABLE');
  equals(store.storeKeyEditState(storeKey), Ember.Store.INHERITED, 'precond - edit state should be INHERITED');
  var oldrev = store.revisions[storeKey] ;
