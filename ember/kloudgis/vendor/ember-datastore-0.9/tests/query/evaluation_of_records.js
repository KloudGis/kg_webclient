...
module("Ember.Query evaluation of records", {
  setup: function() {
    ...
    // setup dummy models
    MyApp.Animal = Ember.Record.extend({});
    MyApp.Person = Ember.Record.extend({
      pet: Ember.Record.toOne(MyApp.Animal, { nested: true })
    });
